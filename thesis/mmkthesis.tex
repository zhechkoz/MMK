...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\mmktitle}{Development of a Semantical Description\\\vspace{0.1cm} % Title of the thesis
            Format for Road Systems Generated\\\vspace{0.2cm}  		% add vspace if your title
     		by SUMO and City Engine for MMK Driving Simulator}          % does not occupy three lines
