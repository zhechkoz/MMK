...
\begin{figure}[htb]
	...
	\subfigure[Unsanitised] {
	  \includegraphics[width=0.35\textwidth]{figures/no-simply}
	  \label{fig:nosimply}
	}\hspace{0.05\textwidth}% \hfill or \hspace{5mm} or \hspace{0.3\textwidth}
	\subfigure[Sanitised] {
	  \includegraphics[width=0.35\textwidth]{figures/simply}
	  \label{fig:simply}
	}
